...
- The data used is from Citi Bikes based in New York, New York.  It is a sample of 10 bikes useage in 2018.  The start and stop time of use, start geo-location, membership type,  age and gender of the user.
...
- Now there are a range of price points to access the scheme including annual subscriptions, pay as you go and concessions.  For this report i have based my work around the 2018 pricing.  At the end of December 2018 there were 3,653 annual members and 33,965 casual users signed up or renewed. Total annual membership stood at 147,090 including memberships purchased with Jersey City billing zip codes.
...
- However there are four points to note from the data that may lead you to consider if the data is fully representative of the populations as a whole and use.

1. Firstly the sample is predominately male (72% of the sample) and as a consequence the results may be overly representative of them. 

2. Secondly the sample is predominately monthly subscription members (xx of the sample) and this data does not include any discounted, single-day pass or single ride users.
...
4. Finally the bikes for rental are only suitable for fully-able bodied individuals.  There are no accessibility bikes or trikes and as a consequence anyone with a disability or limited mobility would not have been included in the data set as they could not use a bike they could not ride.
...
# The age profile of the sample is predominately in the younger age brackets and although the average age of a New Yorker is 37 there are still over 1.2m people in New York over 65

# Subscribers make up significant percentage of the sample - 92%.  Does this pricing structure inhibit the more casual user taking more trips?

# Trips are short and predominately clustered around transport hubs - but there may be other factors impacting on this that would need further research.
...
# Attract older people to join the scheme  Recommendation - consider what the barriers are to older people using the service; are the bikes suitable for older people or people with additional needs?
